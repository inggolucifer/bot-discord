/**
 * ============================================================================
 *  JIANHU BOT — SEED ECONOMY v3.1 (Wuxia & Era Progression, Copper Economy)
 * ============================================================================
 ...
 *   - Max end-game profit = 10 Gold/hari.
 *   - Skala material raksasa, durabilitas item/weapon dicantumkan di deskripsi.
 *   - Waktu pembangunan epik (berhari-hari hingga bulan).
 *
...
async function seedEconomy() {
  try {
    ...
    console.log('📦 [2/5] SEEDING ITEMS (Copper Economy & Weapons)...');
    ...
    console.log('🐾 [4/5] SEEDING PETS...');
    for (const pet of petsData) {
      await upsertPet(pet);
    }
    console.log(`✅ ${petsData.length} pet berhasil ditambahkan.`);

    console.log('🏪 [5/5] MENGATUR SYSTEM SHOP (Hanya Starter Primitif)...');
    const starters = [
    ...
    console.log('  Ekonomi Copper & Wuxia berhasil di-deploy.');
    console.log('=============================================================');
  } catch (err) {
