...
async function seedEconomy() {
  ...
  try {
    ...
    // =========================================================================
    // UPDATE: Penyesuaian ke per-jam karena mekanisme workerAutoProcess menghitung per jam.
    // Menambahkan field workerInputMaterials agar aset otomatis diproses oleh bot, mengonsumsi bahan secara proporsional.
    ...
    const gatherAssets = [
      ...
      { name: "Kebun Anggur", description: "Menghasilkan 10 Anggur Segar/jam. (Butuh 1 Bibit/jam)", rank: "Common", workerOutputItemId: idOf("Anggur Segar"), workerOutputItemName: "Anggur Segar", workerOutputQuantity: 10, workerInputMaterials: [{ itemId: idOf("Bibit Anggur"), itemName: "Bibit Anggur", quantity: 1 }], constructionTimeHours: 2, buildable: true, buildRequirements: [{ itemId: idOf("Cangkul Besi"), itemName: "Cangkul Besi", quantity: 1 }, { itemId: idOf("Bibit Anggur"), itemName: "Bibit Anggur", quantity: 5 }] },
      ...
      // Kehutanan & Tanah (Membutuhkan tool sebagai input maintenance, kita tambahkan tool ini di supply/shop atau item makanan)
      // Karena alat cenderung tidak hancur setiap jam, lebih baik butuh Pakan/Makanan pekerja, kita gunakan "Roti Panggang"
      { name: "Lahan Tanah Liat", description: "Menghasilkan 20 Tanah Liat/jam. (Butuh 1 Roti Panggang/jam)", rank: "Common", workerOutputItemId: idOf("Tanah Liat"), workerOutputItemName: "Tanah Liat", workerOutputQuantity: 20, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }], constructionTimeHours: 2, buildable: true, buildRequirements: [{ itemId: idOf("Cangkul Besi"), itemName: "Cangkul Besi", quantity: 1 }] },
      { name: "Galian Tanah Merah", description: "Menghasilkan 10 Tanah Liat Merah/jam. (Butuh 1 Roti Panggang/jam)", rank: "Uncommon", workerOutputItemId: idOf("Tanah Liat Merah"), workerOutputItemName: "Tanah Liat Merah", workerOutputQuantity: 10, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }], constructionTimeHours: 4, buildable: true, buildRequirements: [{ itemId: idOf("Cangkul Besi"), itemName: "Cangkul Besi", quantity: 2 }] },
      { name: "Area Penebangan Kayu", description: "Menghasilkan 20 Kayu Mentah/jam. (Butuh 1 Roti Panggang/jam)", rank: "Common", workerOutputItemId: idOf("Kayu Mentah"), workerOutputItemName: "Kayu Mentah", workerOutputQuantity: 20, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }], constructionTimeHours: 2, buildable: true, buildRequirements: [{ itemId: idOf("Kapak Besi"), itemName: "Kapak Besi", quantity: 1 }] },
      ...
      { name: "Jagal Hutan", description: "Menghasilkan 5 Kulit Mentah & Daging/jam. (Butuh 1 Pisau Jagal/jam)", rank: "Uncommon", workerOutputItemId: idOf("Kulit Mentah"), workerOutputItemName: "Kulit Mentah", workerOutputQuantity: 5, workerInputMaterials: [{ itemId: idOf("Pisau Jagal"), itemName: "Pisau Jagal", quantity: 1 }], constructionTimeHours: 4, buildable: true, buildRequirements: [{ itemId: idOf("Pisau Jagal"), itemName: "Pisau Jagal", quantity: 1 }, { itemId: idOf("Papan Kayu"), itemName: "Papan Kayu", quantity: 5 }] },

      // Perairan & Nelayan
      { name: "Kolam Pancing Sungai", description: "Menghasilkan 15 Ikan Air Tawar/jam. (Butuh 1 Roti Panggang/jam)", rank: "Common", workerOutputItemId: idOf("Ikan Air Tawar"), workerOutputItemName: "Ikan Air Tawar", workerOutputQuantity: 15, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }], constructionTimeHours: 2, buildable: true, buildRequirements: [{ itemId: idOf("Alat Pancing Kayu"), itemName: "Alat Pancing Kayu", quantity: 2 }] },
      { name: "Dermaga Nelayan Kecil", description: "Menghasilkan 10 Ikan Laut/jam. (Butuh 1 Roti Panggang/jam)", rank: "Uncommon", workerOutputItemId: idOf("Ikan Laut"), workerOutputItemName: "Ikan Laut", workerOutputQuantity: 10, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }], constructionTimeHours: 12, buildable: true, buildRequirements: [{ itemId: idOf("Jaring Nelayan"), itemName: "Jaring Nelayan", quantity: 1 }, { itemId: idOf("Papan Kayu"), itemName: "Papan Kayu", quantity: 30 }] },
      { name: "Tambak Garam Tradisional", description: "Menghasilkan 20 Air Laut/jam. (Butuh 1 Roti Panggang/jam)", rank: "Common", workerOutputItemId: idOf("Air Laut"), workerOutputItemName: "Air Laut", workerOutputQuantity: 20, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }], constructionTimeHours: 4, buildable: true, buildRequirements: [{ itemId: idOf("Cangkul Besi"), itemName: "Cangkul Besi", quantity: 1 }, { itemId: idOf("Batu Kasar"), itemName: "Batu Kasar", quantity: 10 }] },

      // Pertambangan
      { name: "Penggalian Pasir", description: "Menghasilkan 20 Pasir Putih/jam. (Butuh 1 Roti Panggang/jam)", rank: "Common", workerOutputItemId: idOf("Pasir Putih"), workerOutputItemName: "Pasir Putih", workerOutputQuantity: 20, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }], constructionTimeHours: 2, buildable: true, buildRequirements: [{ itemId: idOf("Cangkul Besi"), itemName: "Cangkul Besi", quantity: 1 }] },
      { name: "Tambang Batu Fana", description: "Menghasilkan 20 Batu Kasar/jam. (Butuh 1 Roti Panggang/jam)", rank: "Common", workerOutputItemId: idOf("Batu Kasar"), workerOutputItemName: "Batu Kasar", workerOutputQuantity: 20, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }], constructionTimeHours: 2, buildable: true, buildRequirements: [{ itemId: idOf("Beliung Besi"), itemName: "Beliung Besi", quantity: 1 }] },
    ...
    const funcAssets = [
      ...
      // Kultivasi (Diubah ke /jam untuk sinkronisasi workerAutoProcess)
      {
        name: "Tambang Batu Roh", description: "Menghasilkan 1 Pecahan Batu Roh/jam. (Butuh 1 Roti Panggang/jam)", rank: "Rare",
        workerOutputItemId: idOf("Pecahan Batu Roh"), workerOutputItemName: "Pecahan Batu Roh", workerOutputQuantity: 1, workerInputMaterials: [{ itemId: idOf("Roti Panggang"), itemName: "Roti Panggang", quantity: 1 }],
      ...
      {
        name: "Kebun Spiritual Inti", description: "Menghasilkan 1 Teratai Salju/jam. (Butuh 1 Pecahan Batu Roh/jam)", rank: "Epic",
        workerOutputItemId: idOf("Teratai Salju"), workerOutputItemName: "Teratai Salju", workerOutputQuantity: 1, workerInputMaterials: [{ itemId: idOf("Pecahan Batu Roh"), itemName: "Pecahan Batu Roh", quantity: 1 }],
