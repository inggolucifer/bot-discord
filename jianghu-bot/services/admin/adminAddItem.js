...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const categoryInput = new TextInputBuilder().setCustomId('category').setLabel('Kategori (weapon, law, manual, dll)').setStyle(TextInputStyle.Short).setValue('none').setRequired(false);
