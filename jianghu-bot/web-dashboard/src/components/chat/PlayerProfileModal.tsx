            ...
            <div className="pt-12 px-6 pb-6 overflow-y-auto flex-1 min-h-0 custom-scrollbar">
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                    <div className="bg-black/50 p-2 rounded border border-[#333] flex items-center gap-2">
                        ...
                        <div>
                            <p className="text-[10px] text-gray-500 uppercase tracking-wider font-bold">Ranah Kultivasi</p>
                    ...
                    <div className="bg-black/50 p-2 rounded border border-[#333] flex items-center gap-2">
                        ...
                        <div>
                            <p className="text-[10px] text-gray-500 uppercase tracking-wider font-bold">Tahap</p>
