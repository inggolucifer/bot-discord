...
export default function DashboardModal() {
  ...
  const { activeModal, closeModal, setActiveModal } = useUIStore();
  ...
  if (user && profile && profile.prologueCompleted === false) {
    return <StartPrologue onComplete={() => fetchProfile()} />;
  }
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-black/90 border-b border-[#333] px-6 py-4 flex justify-between items-center z-20">
          <h2 className="text-xl font-serif text-[#c5a880] font-bold flex items-center gap-2">
            <Shield className="w-5 h-5 text-amber-500" /> Profil Pendekar
          </h2>
          <button onClick={closeModal} className="text-gray-400 hover:text-white bg-gray-900 hover:bg-gray-800 p-2 rounded-full transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-8 flex-grow">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            ...
                            className={`py-1.5 text-xs rounded-lg border font-medium transition-all ${webGender === 'Laki-laki'
                          ...
                          <button
                            ...
                            className={`py-1.5 text-xs rounded-lg border font-medium transition-all ${webGender === 'Perempuan'
                                ? 'bg-amber-950/80 border-amber-500 text-amber-200'
                                : 'bg-black/50 border-gray-800 text-gray-400 hover:border-gray-700'
                              }`}
                          >
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 sm:gap-6">
            <button onClick={(e) => { e.preventDefault(); setActiveModal('inventory'); }} className="group relative bg-[#111] border border-[#333] p-5 sm:p-6 rounded-lg hover:border-[#c5a880] hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(197,168,128,0.1)] transition-all duration-300 flex flex-col items-center text-center gap-3 overflow-hidden">
            ...
            <button onClick={(e) => { e.preventDefault(); setActiveModal('assets'); }} className="group relative bg-[#111] border border-[#333] p-5 sm:p-6 rounded-lg hover:border-[#8b0000] hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(139,0,0,0.1)] transition-all duration-300 flex flex-col items-center text-center gap-3 overflow-hidden">
            ...
            <button onClick={(e) => { e.preventDefault(); setActiveModal('sect'); }} className="group relative bg-[#111] border border-[#333] p-5 sm:p-6 rounded-lg hover:border-[#1f402e] hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(31,64,46,0.1)] transition-all duration-300 flex flex-col items-center text-center gap-3 overflow-hidden">
            ...
            <button onClick={(e) => { e.preventDefault(); setActiveModal('pet'); }} className="group relative bg-[#111] border border-[#333] p-5 sm:p-6 rounded-lg hover:border-blue-900 hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(30,58,138,0.1)] transition-all duration-300 flex flex-col items-center text-center gap-3 overflow-hidden">
