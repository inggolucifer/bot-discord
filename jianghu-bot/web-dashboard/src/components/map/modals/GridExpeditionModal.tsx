...
export default function GridExpeditionModal({
  ...
  return (
    <div className="absolute inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 select-none animate-in fade-in duration-200">
      <div className="bg-gradient-to-b from-[#1c182b] to-[#0c0a17] border border-indigo-500/70 rounded-xl max-w-md w-full p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto flex flex-col">
        <button
          onClick={onClose}
