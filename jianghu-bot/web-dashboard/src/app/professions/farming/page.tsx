        ...
        <div className="container mx-auto p-4 max-w-4xl text-gray-100">
            ...
            {!activeSessionId ? (
                <div className="bg-gray-900 border border-amber-500/50 p-8 rounded-xl shadow-2xl mt-8">
                    <h2 className="text-2xl font-bold mb-4 text-amber-500">Persiapan Bertani</h2>
                    ...
                    <div className="space-y-4 mb-6">
                        ...
                        <div>
                            ...
                            <input type="text" value={toolItemId} onChange={e => setToolItemId(e.target.value)} className="w-full bg-gray-800 border border-gray-700 rounded p-2 text-white" placeholder="ObjectId Cangkul" />
                        </div>
                    </div>
                ...
                <div className="mt-8 text-center py-12 bg-gray-900 border border-amber-500/50 rounded-xl shadow-2xl">
                    ...
                    >
                        {completeMutation.isPending ? 'Menyelesaikan...' : 'Selesaikan Panen'}
                    </button>
                </div>
            )}
        </div>
