  ...
  return (
    <div className="p-3 sm:p-6 md:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 space-y-6 flex flex-col">
          ...
          <div className="bg-[#1a1a1a] border border-[#c5a880]/30 rounded-lg p-6 shadow-lg flex flex-col items-center flex-1">
              <h3 className="text-lg font-bold text-[#c5a880] mb-6 w-full text-center border-b border-[#333] pb-2">Combat Stats</h3>
              <div className="grid grid-cols-2 gap-x-8 gap-y-4 w-full">
                 <div className="flex justify-between items-center bg-black/40 px-3 py-2 rounded">
                    <span className="text-gray-400 text-sm flex items-center gap-1.5"><Sword size={14}/> ATK</span>
                    <span className="text-red-400 font-bold text-lg">{computedStats.atk}</span>
                 </div>
                 <div className="flex justify-between items-center bg-black/40 px-3 py-2 rounded">
                    <span className="text-gray-400 text-sm flex items-center gap-1.5"><Shield size={14}/> DEF</span>
                    <span className="text-blue-400 font-bold text-lg">{computedStats.def}</span>
                 </div>
                 <div className="flex justify-between items-center bg-black/40 px-3 py-2 rounded">
                    <span className="text-gray-400 text-sm flex items-center gap-1.5"><Zap size={14}/> SPD</span>
                    <span className="text-sky-400 font-bold text-lg">{computedStats.spd}</span>
                 </div>
                 <div className="flex justify-between items-center bg-black/40 px-3 py-2 rounded">
                    <span className="text-gray-400 text-sm flex items-center gap-1.5"><Heart size={14}/> HP</span>
                    <span className="text-green-400 font-bold text-lg">{computedStats.maxHp}</span>
                 </div>
              </div>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-stretch mt-6">
          <div className="flex-1 bg-[#1a1a1a] border border-[#c5a880]/30 rounded-lg p-6 shadow-lg flex flex-col items-center min-h-[300px]">
