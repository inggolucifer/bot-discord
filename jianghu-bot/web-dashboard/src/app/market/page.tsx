    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <section className="bg-[#1a1a1a] jianghu-border rounded-lg overflow-hidden flex flex-col">
          ...
          <div className="p-6 grid gap-4 flex-grow max-h-[600px] overflow-y-auto custom-scrollbar">
            {shopItems.length === 0 ? (
               <div className="text-center py-10 text-gray-500">Toko sedang kosong.</div>
            ) : shopItems.map(item => (
