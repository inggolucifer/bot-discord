  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '⚒️ Crafting', value: '`/craft [nama-aset] [nama-resep]` — Buat item lewat aset crafting yang kamu miliki' },
