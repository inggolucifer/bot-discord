...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub => sub.setName('daftar').setDescription('Daftarkan dirimu sebagai pekerja lepas').addIntegerOption(o => o.setName(WORKER_OPTIONS.HARGA_PER_JAM).setDescription('Harga jasa per jam (Silver)').setRequired(true).setMinValue(1)).addIntegerOption(o => o.setName(WORKER_OPTIONS.MAKS_DURASI_JAM).setDescription('Maksimal lama kerja dalam satu sewa').setRequired(true).setMinValue(1)))
