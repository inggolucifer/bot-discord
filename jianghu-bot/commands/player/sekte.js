...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub => sub.setName('donasi').setDescription('Donasikan currency ke sekte').addStringOption(o => o.setName('jenis').setDescription('Jenis currency').setRequired(true).addChoices({ name: 'Copper Tael', value: 'copper' }, { name: 'Silver Tael', value: 'silver' }, { name: 'Gold Ingot', value: 'gold' }, { name: 'Spirit Jade', value: 'jade' }, { name: 'Heavenly Spirit', value: 'spirit' })).addIntegerOption(o => o.setName('jumlah').setDescription('Jumlah donasi').setRequired(true).setMinValue(1)))
