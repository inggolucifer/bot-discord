...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommandGroup(group => group
      ...
      .addSubcommand(sub => sub.setName('set-worker-input').setDescription('Set bahan baku pekerja per jam').addStringOption(o => o.setName('nama-aset').setDescription('Nama aset').setRequired(true).setAutocomplete(true)).addStringOption(o => o.setName('item-bahan').setDescription('Bahan baku').setRequired(true).setAutocomplete(true)).addIntegerOption(o => o.setName('jumlah-bahan').setDescription('Jumlah per jam').setRequired(true)))
