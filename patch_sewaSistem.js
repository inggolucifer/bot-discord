const fs = require('fs');
let content = fs.readFileSync('jianghu-bot/services/player/worker/sewaWorkerSistem.js', 'utf8');
...
fs.writeFileSync('jianghu-bot/services/player/worker/sewaWorkerSistem.js', content);
